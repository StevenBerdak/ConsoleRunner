# ζetaConsole
A simple lightweight single-class API to map commands to methods for use within console based applications. Provides basic console commands and execution flow control using flags.
